#!/usr/bin/env bash
# 其他Paas保活
PAAS1=bcyy41-drefcre.b4a.run
PAAS2=
PAAS3=

# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'ec76e18f-601f-4bbe-bf05-0fbc51df529c'}
...
ARGO_AUTH='{"AccountTag":"993c0c0e3841411c18e8b7d09c491074","TunnelSecret":"MlcjSOFnL3h/jFlg7NCQnbBVVoT+xXfeG4zLH3MC03M=","TunnelID":"1a463c18-e9c7-42ad-8d84-47f1b03ed6f0"}'
ARGO_DOMAIN=byyr4.sewsdr.ga
